...
if ( ! function_exists( 'school_hub_is_news_ticker_active' ) ) :
	 ...
	 */
	function school_hub_is_news_ticker_active( $control ) {
...
if ( ! function_exists( 'school_hub_is_featured_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function school_hub_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'school_hub_is_featured_page_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function school_hub_is_featured_page_slider_active( $control ) {
...
if ( ! function_exists( 'school_hub_is_image_in_archive_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function school_hub_is_image_in_archive_active( $control ) {
...
if ( ! function_exists( 'school_hub_is_image_in_single_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function school_hub_is_image_in_single_active( $control ) {
